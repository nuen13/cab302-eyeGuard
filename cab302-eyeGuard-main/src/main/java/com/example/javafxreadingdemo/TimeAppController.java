...
//        updateTimerLabel();
    ...
    private void changeTimePreset(boolean breakTimePreset){
        if(breakTimePreset){
            ...
            breaktime.setStyle("-fx-background-color: #66BB6A; -fx-text-fill: white; -fx-font-size: 14px; -fx-padding: 8px 16px; -fx-background-radius: 5px; -fx-border-radius: 5px; -fx-cursor: hand;");
            worktime.setStyle("");
        }
        else {
            ...
            worktime.setStyle("-fx-background-color: #66BB6A; -fx-text-fill: white; -fx-font-size: 14px; -fx-padding: 8px 16px; -fx-background-radius: 5px; -fx-border-radius: 5px; -fx-cursor: hand;");
            breaktime.setStyle("");
